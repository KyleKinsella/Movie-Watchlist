...
## So then I was asked to refactor my retrieveMovie(...) function, to change it from a string-builder to be a movie object, this is where the Movie.java file is used. (this was an additional part to the interview!)
